...
Begin VB.Form frmAbout 
   ...
   Begin AddressBook.chameleonButton chameleonButton1 
      Height          =   225
      Left            =   1455
      TabIndex        =   5
      Top             =   1980
...
Private Sub chameleonButton1_Click()
    Unload Me
    MsgBox "Credits:" & vbCrLf & "Chameleon Button™ - By gonchuki (gonchuki@yahoo.es)"
End Sub
